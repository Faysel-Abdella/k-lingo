  ...
  return (
    <div className="min-h-[1117px] flex flex-col items-center justify-between">
      ...
      <div className="flex flex-col items-center justify-start max-sm:w-[85%] max-lg:w-[55%] w-[40%] min-h-[293px] gap-[40px] mt-10 mb-10 flex-1">
        ...
        <div className="flex flex-col justify-center items-center w-full min-h-[447px] gap-[24px]">
          <Card className="w-full min-h-[187px] rounded-xl border shadow-sm border-[#8D64F8] gap-[10px]">
            <CardBody className="flex flex-col items-center w-full justify-center ">
              {/*------ ----- --- Top --- ----- ------- */}

              <div className="w-full min-h-[54px] flex flex-row items-center justify-between gap-[20px] max-sm:items-start max-sm:flex-col">
                {/*RIGHT */}
                ...
                <div className="w-[40%] max-sm:w-full max-sm:justify-start min-h-[44px] flex flex-row items-center  max-sm:items-start justify-end gap-[10px]">
                  ...
                  <div>
                    <Button className="min-w-[80px] h-[44px] text-[14px] text-[#FFFFFF] bg-[#8D64F8] px-4 py-3 rounded-md font-bold">
                      {" "}
                      구매하기
                    </Button>
                  </div>
                ...
                <div className="flex-1 min-h-[48px] flex flex-col max-sm:justify-start justify-center gap-[10px]">
                  ...
                  <div className="w-full flex flex-row items-start">
                    <p className="text-[10px] text-[#868F9A]">
                      ...
                      한정함
                      <br />
                      -연회원을 이용한 적이 없는 회원이 할인권을 결제한 경우는
                      이용 점수가 차감되니 유의하시기 바랍니다.
                    </p>
                  </div>
                </div>
          ...
          <div className="w-full">
            <Card className="w-full min-h-[94px] shadow-sm rounded-xl border">
              <CardBody className="flex full flex-col items-center justify-center gap-[5px]">
                <div className="w-full min-h-[54px] max-sm:flex-col flex flex-row items-center justify-between gap-[6px]">
                  {/*RIGHT */}
                  ...
                  <div className="w-[55%] max-sm:w-full min-h-[44px] max-sm:justify-start  max-sm:items-start flex flex-row items-center justify-end gap-[10px]">
                    ...
                    <div>
                      <Button className="w-[80px] h-[44px] text-[14px] text-[#8D64F8] bg-white border border-[#8D64F8] px-4 py-3 rounded-md font-bold">
                        {" "}
                        구매하기
                      </Button>
                    </div>
