    ...
    <div className="min-h-[100vh] flex flex-col items-center justify-between">
      ...
      <div className="flex flex-row w-[75%] items-start max-md:justify-start max-md:items-start max-lg:w-[85%] max-md:w-[100%] gap-[10px]">
        ...
        <div className="flex flex-col items-start justify-start flex-1 max-md:w-[75%] max-md:px-[5%] h-auto pt-[30px] max-md:pt-[10%] gap-[20px]">
          {/* Heading  */}
          <div className="flex flex-row items-center justify-between border-b w-full min-h-[76px]">
          ...
          <div className="flex flex-row items-center justify-between flex-wrap p-[16px] border rounded-lg w-full min-h-[72px]">
            <div className="flex flex-row items-start justify-start w-[50%] min-h-[20px] flex-wrap gap-[20px]">
          ...
          {/* Icons  */}
          <div className="flex flex-row items-center justify-between w-full min-h-[33px]">
            {/* LEFT SIDE  */}
            ...
            {/* RIGHT SIDE */}
            <div className="flex flex-row items-center justify-center flex-wrap min-h-[33px] gap-[8px]">
              {/* Dropdown 1 */}
              <DropDown
                options={options}
              ...
              {/* Button */}
              <Button className="w-[45px] h-full box-border bg-[#ECEDF1] text-[12px] text-[#868F9A] rounded-md py-[10px]">
                목록
              </Button>
            </div>
          </div>
          ...
          <div className="flex flex-row items-center justify-between w-full min-h-[40px]">
            ...
            <InputNoLabel
              ...
              inputParentStyles="w-80% h-full rounded-md py-[10px] px-[16px]"
              mainStyles="w-full"
            />
