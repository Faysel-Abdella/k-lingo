      ...
      <div className="flex flex-row items-start justify-start w-[75%] max-lg:w-[85%] max-md:w-[100%] h-auto  gap-[20px]">
        ...
        <div className="flex flex-col items-start justify-start w-[75%] max-md:w-[100%] h-auto pt-[30px] max-md:pt-[10%] max-md:px-[5%] gap-[20px]">
          ...
          <div className="flex flex-col items-center justify-center w-full min-h-[86px] gap-[12px]">
            ...
            <div className="flex flex-row max-md:flex-wrap items-center justify-center w-[75%] min-h-[44px] gap-[12px]">
              {/* Dropdown */}
              <DropDown
                options={options}
                defaultSelectedKeys="1"
                selectStyles="flex-1 h-full"
              ...
              <InputNoLabel
                placeholder="사미인곡"
                inputParentStyles="flex-2 h-full rounded-md px-[16px]"
                mainStyles="w-full"
              />

              {/* Button */}
              <Button className="flex-1 h-full px-[20px] py-[10px] bg-[#ECEDF1] text-[#868F9A] rounded-md">
                검색
              </Button>
            </div>
          </div>

          <div className="flex flex-col items-start justify-start w-full min-h-[795px] gap-[20px] pt-10">
