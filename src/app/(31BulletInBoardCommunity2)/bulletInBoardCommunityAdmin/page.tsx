      ...
      <div className="flex min-h-full flex-row w-[75%] items-start max-md:justify-start max-md:items-start max-lg:w-[85%] max-md:w-[100%] gap-[25px]">
        ...
        <div className="flex flex-col items-start justify-start flex-1 max-md:w-[75%] max-md:px-[5%] min-h-auto pt-[30px] max-md:pt-[70px] gap-[20px]">
          ...
          <div className="flex flex-col items-center justify-center w-full min-h-[54px]">
            <div className="w-full min-h-[34px] pl-2 ">
          ...
          <div className="w-full gap-[20px]">
            <div className="flex flex-row items-center pl-2 justify-between w-full min-h-[36px]">
              <Button className="min-w-[117px] min-h-[36px] font-bold rounded-md py-[8px] px-[14px] text-[14px] bg-[#ECEDF1] text-[#868F9A] flex items-center">
                선택 게시글 삭제
              </Button>

              <Button className="min-w-[64px] min-h-[36px] font-bold rounded-md py-[8px] px-[14px] text-[14px] bg-[#E0F1FF] text-[#42A8FD] flex items-center">
                글쓰기
              </Button>
            </div>
                ...
                <Table
                  ...
                  bottomContent={
                    <div className="flex flex-col items-center justify-center pt-2 w-full gap-[40px]">
                      ...
                      {/* Button */}
                      {/* <Button className="w-[64px] min-h-full px-[20px] py-[10px] bg-[#ECEDF1] text-[#868F9A] rounded-md">
                                                검색
                                            </Button>
                                        </div> */}
                    </div>
