    ...
    <div className="min-h-[100vh] w-full flex flex-col items-center justify-between ">
      ...
      <div className="flex h-full flex-row w-[75%] items-start max-md:justify-start max-md:items-start max-lg:w-[85%] max-md:w-[100%] gap-[10px]">
        ...
        <div className="flex flex-col items-start justify-start flex-1 max-md:w-[75%] max-md:px-[5%] h-auto pt-[30px] max-md:pt-[100px] gap-[20px]">
          ...
          {/* Icons  */}
          <div className="flex flex-row flex-wrap items-center justify-between w-full min-h-[33px] gap-[20px]">
            {/* LEFT SIDE  */}
            ...
            {/* RIGHT SIDE */}
            <div className="flex flex-row flex-wrap items-center flex-1 justify-end min-w-[210px] min-h-[33px] gap-[8px]">
              {/* Dropdown 1 */}
              <DropDown
                options={options}
              ...
              {/* Button */}
              <Button className="min-w-[45px] py-[12px] h-full box-border bg-[#ECEDF1] text-[12px] text-[#868F9A] rounded-md">
                목록
              </Button>
            </div>
          </div>
